...
const sliders: SliderConfig[] = [
  {
    ...
    leftLabel: "Mission-First (20%)",
    leftExample: "Values-driven, community impact focus",
    rightLabel: "Margin-First (80%)",
  ...
  },
  {
    ...
    leftLabel: "Efficiency-Focused (20%)",
    leftExample: "Quick service, high throughput",
    rightLabel: "Experience-Focused (80%)",
  ...
  },
  {
    ...
    leftLabel: "Volume-Driven (20%)",
    leftExample: "Accessible pricing, high turnover",
    rightLabel: "Premium-Driven (80%)",
  ...
  },
  {
    ...
    leftLabel: "Local Anchor (20%)",
    leftExample: "Community hub for regulars",
    rightLabel: "Destination Draw (80%)",
  ...
  },
  {
    ...
    leftLabel: "Systems-First (20%)",
    leftExample: "Standardized, minimal training",
    rightLabel: "Development-First (80%)",
  ...
  },
  {
    ...
    leftLabel: "Tradition-Focused (20%)",
    leftExample: "Consistent classics, proven methods",
    rightLabel: "Innovation-Focused (80%)",
